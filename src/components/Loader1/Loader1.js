  ...
  return (
    <div className="loader">
      <div className="svg-wrapper">
        ...
        <div className="loading-text">Welcome to Library Management System</div>
        <div className="loading1-text">"Created By"</div>
        <div className="loading2-text">"Bijan Shrestha"</div>
      </div>
    </div>
  );
};
